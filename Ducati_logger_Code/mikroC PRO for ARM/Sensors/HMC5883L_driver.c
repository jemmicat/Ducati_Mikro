...
static void HMC5883L_Write(unsigned short address, unsigned short data1) {
  ...
  Magnetdata_[1] = data1;
  I2C1_Write(_HMC5883L_ADDRESS, Magnetdata_, 2, END_MODE_STOP);
}
...
void HMC5883L_Read(int *data_X, int *data_Y, int *data_Z){
  ...
  I2C1_Start();              // issue I2C start signal
  I2C1_Write(_HMC5883L_ADDRESS, Magnetdata_, 1, END_MODE_RESTART);
  I2C1_Read(_HMC5883L_ADDRESS, Magnetdata_, 6, END_MODE_STOP);
...
static unsigned short HMC5883L_Read_Register(unsigned short address) {
  ...
  Magnetdata_[0] = address;
  I2C1_Write(_HMC5883L_ADDRESS, Magnetdata_, 1, END_MODE_RESTART);
  I2C1_Read(_HMC5883L_ADDRESS, Magnetdata_, 1, END_MODE_STOP);
