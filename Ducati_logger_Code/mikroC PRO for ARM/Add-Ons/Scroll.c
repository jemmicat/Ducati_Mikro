...
unsigned int temp;
  ...
  TFT_mikromedia_Write_Command(Hi(first));
  TFT_mikromedia_Write_Command(Lo(first));
  temp = last - first;
  TFT_mikromedia_Write_Command(Hi(temp));
  TFT_mikromedia_Write_Command(Lo(temp));
...
void Scroll(unsigned int scroll) {
  ...
  TFT_mikromedia_Set_Index(0x37);
  TFT_mikromedia_Write_Command(Hi(scroll));
  TFT_mikromedia_Write_Command(Lo(scroll));
